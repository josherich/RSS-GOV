...
host_name = (id) => {
    const keys = {
        ...
        "1265": "The Daily",
        "1264": "LA Times",
        "1263": "Quartz Technology",
        "1262": "The Atlantic",
        "1261": "参考消息",
        "1260": "谷雨实验室",
        "1259": "新浪 创事记",
        "1258": "wikipedia mainland",
        "1257": "腾讯大家",
        "1256": "国务院 吹风会",
        "1255": "东方网",
        "1254": "21财经 政治",
...
module.exports = async (ctx) => {
    ...
    const items = response2.data['hits']['hits'].map( page => {
        return {
            "title": page['_source']['page_title'].replace('\\"','"').replace('\"','"').replace('\n',''),
            "content": page['_source']['page_raw'].replace('\\"','"').replace('\"','"').replace('\n',''),
